        ...
        <check_items>
            ...
            <item id="12">
                ...
                <description>
                    ...
                    判定は空行で区切られた一つのセリフ・一つの発話ブロック内に限定してください。空行をまたいだ別チャンク同士の語句は、重言・同語反復としてカウントしないでください。
                ...
                <detection_target>
                    ...
                    <category>一つのセリフ・一つの発話ブロック内で、同じ語句や同じ意味の表現が不自然に繰り返されている箇所（例: 「私が自分で自分の目で見た」「絶対に必ず来て」「確認して、確認結果を確認する」）</category>
                    <category>近接する文で言い換えなしに同じ内容を続けて述べ、冗長に見える箇所</category>
                </detection_target>
                <exclusion>
                    <item>キャラクターの口癖、強調、畳みかけ、ギャグ、演出として明確に機能している反復</item>
                    <item>空行を挟んだ別チャンク間の繰り返し、別々の人物の会話応答として自然な繰り返し</item>
                </exclusion>
            ...
            <item id="13">
                ...
                <description>
                    ...
                    吹き出し内の表示都合で改行されていても、単語の途中で切れて読みづらい場合は確認対象にしてください。ただし空行で区切られた別チャンクをまたぐ箇所は、単語途中の改行として扱わないでください。
                </description>
                <detection_target>
