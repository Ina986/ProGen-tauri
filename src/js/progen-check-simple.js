...
function generateUnificationRulesXmlForCheck() {
    ...
    // カテゴリ定義
    const categories = {
        'basic': { name: '基本的に表記変更', color: 'red' },
        'recommended': { name: '表記が推奨', color: 'blue' },
        'auxiliary': { name: '補助動詞', color: 'green' },
        'difficult': { name: '難読文字', color: 'yellow' },
        'pronoun': { name: '人称', color: 'purple' },
        'character': { name: '人物名（ルビ用）', color: 'person' }
    };
...
// ES Module exports
export { getNonJoyoCheckItemXml, generateSimpleCheckWithRulesPromptWithText, generateUnificationRulesXmlForCheck };

// Expose to window for inline HTML handlers
Object.assign(window, { getNonJoyoCheckItemXml, generateSimpleCheckWithRulesPromptWithText, generateUnificationRulesXmlForCheck });
