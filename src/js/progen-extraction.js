...
function updateHeaderSaveButtons() {
    ...
    const headerRenameBtn = document.getElementById('headerRenameWorkBtn');
    const saveGroup = document.getElementById('actionBarSaveGroup');
    const hasCurrentJson = typeof state.currentJsonPath !== 'undefined' && state.currentJsonPath;
    ...
    if (headerRenameBtn) {
        headerRenameBtn.style.display = hasCurrentJson ? 'inline-flex' : 'none';
    }
    if (saveGroup) {
